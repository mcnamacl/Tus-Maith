...
client = OpenAI(api_key=os.environ.get('API-Key'))

# Call the GPT API.
def call_gpt_api(LLM_role, ontology, user_prompt):
    try:
        response = client.chat.completions.create(
            model="gpt-4o",  # GPT model being accessed.
            messages=[
                {
                    "role": "system",
                    "content": LLM_role 
...
data = call_gpt_api("", full_ontology, prompt_zero_shot)
...
data = call_gpt_api("", ontology_subset, prompt_zero_shot)
file_path = "Run2.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api("", ontology_subset_relationships, prompt_zero_shot_relationships)
file_path = "Run3.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api("", full_ontology, prompt_few_shot)
file_path = "Run4.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api("", ontology_subset, prompt_few_shot)
file_path = "Run5.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api("", ontology_subset_relationships, prompt_few_shot_relationships)
file_path = "Run6.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api(LLM_role, full_ontology, prompt_zero_shot)
file_path = "Run7.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api(LLM_role, ontology_subset, prompt_zero_shot)
file_path = "Run8.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api(LLM_role, ontology_subset_relationships, prompt_zero_shot_relationships)
file_path = "Run9.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api(LLM_role, full_ontology, prompt_few_shot)
file_path = "Run10.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api(LLM_role, ontology_subset, prompt_few_shot)
file_path = "Run11.xlsx"  # Path to your Excel file
sheet_name = "Tabelle1"  # Sheet where you want to add data
add_column_to_excel(file_path, sheet_name, 0, data)

data = call_gpt_api(LLM_role, ontology_subset_relationships, prompt_few_shot_relationships)
